...
/** telegram IDs currently waiting to paste their ListenBrainz token */
const pendingTokenInput = new Set<number>();
...
composer.on("message:text", async (context) => {
  ...
  pendingTokenInput.delete(from.id);
